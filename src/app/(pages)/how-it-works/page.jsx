          ...
          <div className="text-center mb-16">
            ...
            <div className="inline-flex items-center bg-gray-200 rounded-full p-1 mb-12">
              <button
                ...
                className={`px-8 py-3 rounded-full text-sm font-medium transition-colors flex items-center ${
                  activeFlow === "client"
                ...
                <div className="space-y-12">
                  {clientSteps.map((step, index) => (
                    ...
                    >
                      ...
                      {/* Step Content */}
                      <div
                        className={`relative w-full lg:w-[45%] bg-gray-50 rounded-2xl p-6 shadow-md ${
                ...
                <div className="space-y-12">
                  {talentSteps.map((step, index) => (
                    ...
                    >
                      ...
                      {/* Step Content */}
                      <div
                        className={`relative w-full md:w-[45%] bg-gray-50 rounded-2xl p-6 shadow-md ${
                          index % 2 === 0 ? "md:ml-12" : "md:mr-12"
                        }`}
                      >
                        <h3
